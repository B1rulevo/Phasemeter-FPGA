...
-- Date        : Tue Jul  7 15:57:40 2026
-- Host        : DESKTOP-DBG01T0 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top design_1_fir_compiler_0_3 -prefix
--               design_1_fir_compiler_0_3_ design_1_fir_compiler_0_0_stub.vhdl
...
entity design_1_fir_compiler_0_3 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_fir_compiler_0_3 : entity is "design_1_fir_compiler_0_0,fir_compiler_v7_2_23,{}";
  attribute core_generation_info : string;
  attribute core_generation_info of design_1_fir_compiler_0_3 : entity is "design_1_fir_compiler_0_0,fir_compiler_v7_2_23,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=fir_compiler,x_ipVersion=7.2,x_ipCoreRevision=23,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_XDEVICEFAMILY=zynq,C_ELABORATION_DIR=./,C_COMPONENT_NAME=design_1_fir_compiler_0_0,C_COEF_FILE=design_1_fir_compiler_0_0.mif,C_COEF_FILE_LINES=70,C_FILTER_TYPE=0,C_INTERP_RATE=1,C_DECIM_RATE=1,C_ZERO_PACKING_FACTOR=1,C_SYMMETRY=1,C_NUM_FILTS=1,C_NUM_TAPS=127,C_NUM_CHANNELS=1,C_CHANNEL_PATTERN=fixed,C_ROUND_MODE=4,C_COEF_RELOAD=0,C_NUM_RELOAD_SLOTS=1,C_COL_MODE=1,C_COL_PIPE_LEN=4,C_COL_CONFIG=7,C_OPTIMIZATION=2046,C_DATA_PATH_WIDTHS=12_12,C_DATA_IP_PATH_WIDTHS=24,C_DATA_PX_PATH_WIDTHS=24,C_DATA_WIDTH=24,C_COEF_PATH_WIDTHS=18_18,C_COEF_WIDTH=18,C_DATA_PATH_SRC=0_1,C_COEF_PATH_SRC=0_0,C_PX_PATH_SRC=0_1,C_DATA_PATH_SIGN=1_0,C_COEF_PATH_SIGN=1_1,C_ACCUM_PATH_WIDTHS=27_27,C_OUTPUT_WIDTH=24,C_OUTPUT_PATH_WIDTHS=24,C_ACCUM_OP_PATH_WIDTHS=39,C_EXT_MULT_CNFG=0_1_0_12,C_DATA_PATH_PSAMP_SRC=0,C_OP_PATH_PSAMP_SRC=0,C_NUM_MADDS=7,C_OPT_MADDS=none,C_OVERSAMPLING_RATE=10,C_INPUT_RATE=10,C_OUTPUT_RATE=10,C_DATA_MEMTYPE=0,C_COEF_MEMTYPE=2,C_IPBUFF_MEMTYPE=0,C_OPBUFF_MEMTYPE=0,C_DATAPATH_MEMTYPE=0,C_MEM_ARRANGEMENT=1,C_DATA_MEM_PACKING=0,C_COEF_MEM_PACKING=0,C_FILTS_PACKED=0,C_LATENCY=27,C_HAS_ARESETn=0,C_HAS_ACLKEN=0,C_DATA_HAS_TLAST=0,C_S_DATA_HAS_FIFO=1,C_S_DATA_HAS_TUSER=0,C_S_DATA_TDATA_WIDTH=24,C_S_DATA_TUSER_WIDTH=1,C_M_DATA_HAS_TREADY=0,C_M_DATA_HAS_TUSER=0,C_M_DATA_TDATA_WIDTH=24,C_M_DATA_TUSER_WIDTH=1,C_HAS_CONFIG_CHANNEL=0,C_CONFIG_SYNC_MODE=0,C_CONFIG_PACKET_SIZE=0,C_CONFIG_TDATA_WIDTH=1,C_RELOAD_TDATA_WIDTH=1}";
