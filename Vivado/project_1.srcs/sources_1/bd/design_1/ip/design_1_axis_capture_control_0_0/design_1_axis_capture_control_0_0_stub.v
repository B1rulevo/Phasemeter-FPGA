...
//               c:/FPGA/Phasemeter/Vivado/project_1.srcs/sources_1/bd/design_1/ip/design_1_axis_capture_control_0_0/design_1_axis_capture_control_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_axis_capture_control_0_0,axis_capture_controller,{}" *) (* CORE_GENERATION_INFO = "design_1_axis_capture_control_0_0,axis_capture_controller,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=axis_capture_controller,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "axis_capture_controller,Vivado 2024.2" *) 
module design_1_axis_capture_control_0_0(aclk, aresetn, sample_count, trigger_async, 
  capture_done, busy, capture_enable, s_axis_tdata, s_axis_tvalid, s_axis_tready, m_axis_tdata, 
  m_axis_tvalid, m_axis_tready, m_axis_tlast, m_axis_tkeep)
/* synthesis syn_black_box black_box_pad_pin="aresetn,sample_count[31:0],trigger_async,capture_done,busy,capture_enable,s_axis_tdata[31:0],s_axis_tvalid,s_axis_tready,m_axis_tdata[31:0],m_axis_tvalid,m_axis_tready,m_axis_tlast,m_axis_tkeep[3:0]" */
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF m_axis:s_axis, ASSOCIATED_RESET aresetn, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
