...
--               c:/FPGA/Phasemeter/Vivado/project_1.srcs/sources_1/bd/design_1/ip/design_1_leds_0_0/design_1_leds_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_leds_0_0_leds is
  ...
  signal \NLW_cnt_reg[24]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_cnt_reg[24]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
\cnt_reg[24]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_cnt_reg[24]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \cnt_reg[24]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_cnt_reg[24]_i_1_O_UNCONNECTED\(3 downto 2),
...
entity design_1_leds_0_0 is
  ...
  attribute X_CORE_INFO of design_1_leds_0_0 : entity is "leds,Vivado 2024.2";
end design_1_leds_0_0;

architecture STRUCTURE of design_1_leds_0_0 is
begin
inst: entity work.design_1_leds_0_0_leds
     port map (
      clk_i => clk_i,
      led_o => led_o
    );
